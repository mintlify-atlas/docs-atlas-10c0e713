...
<Note>
**Prerequisites**
- BMad installed in your project (see [How to Install BMad](./install-bmad))
...
Guidance on building expansion modules and customizing existing modules is coming soon. For now, see [BMad Builder](https://github.com/bmad-code-org/bmad-builder) for creating custom agents and workflows.
