...
<Accordion title="Non-interactive installation for CI/CD">
  ...
  See [Non-Interactive Installation Guide](/how-to/non-interactive-installation) for all options.
</Accordion>
...
<Tip>
  **Project Context (Optional but Recommended)**
  ...
  [Learn more about Project Context](/explanation/project-context)
</Tip>
