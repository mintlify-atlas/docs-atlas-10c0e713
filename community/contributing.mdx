---
title: Contributing to BMad Method
description: Learn how to contribute to BMad Method - Bug reports, feature requests, pull requests, and community contributions
---
...
1. **Search existing issues** — Use the [GitHub issue search](https://github.com/bmad-code-org/BMAD-METHOD/issues) to check if your bug or feature has already been reported
...
**For community modules**, review [TRADEMARK.md](https://github.com/bmad-code-org/BMAD-METHOD/blob/main/TRADEMARK.md) for proper naming conventions (e.g., "My Module (BMad Community Module)").
...
By participating, you agree to abide by our [Code of Conduct](https://github.com/bmad-code-org/BMAD-METHOD/blob/main/.github/CODE_OF_CONDUCT.md).

## License

By contributing, your contributions are licensed under the same MIT License. See [CONTRIBUTORS.md](https://github.com/bmad-code-org/BMAD-METHOD/blob/main/CONTRIBUTORS.md) for contributor attribution.
